...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="navbar-header">
    ...
    <!--  <img height="20" width="20" src="/resource/images/brandimg.jpg"class="img-responsive pull-left" alt="Responsive image"> -->
     <!--  <img alt="Brand" src="/resource/images/brandimg.jpg">-->
...
<div class="container">
 ...
 <strong> <h3>WELCOME TO WATCH WORLD </h3></strong>
</div>
