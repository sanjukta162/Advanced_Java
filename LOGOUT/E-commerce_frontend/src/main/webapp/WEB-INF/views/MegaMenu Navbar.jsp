...
<link rel="stylesheet" type="text/css" href="/WEB-INF/resource/css/css.css">
</head>
                ...
                <div class="collapse navbar-collapse js-navbar-collapse">
                		<ul class="nav navbar-nav navbar-left">
                			<a class="navbar-brand" href="#">
                						<img height="20" width="20" src="img1"class="img-responsive pull-left" alt="Responsive image">
                					 Time To Time Navbar</a>
                				...
                				<ul class="dropdown-menu mega-dropdown-menu">
                                            ...
                                            <div id="menCollection" class="carousel slide" data-ride="carousel">
                                              <div class="carousel-inner">
                                                <div class="item active">
                                                    <a href="#"><img src="Watch1" class="img-responsive" alt="product 1"></a>
                                                    <h4><small>Swiss Quartz Black Dial Watch</small></h4>                                        
                                                    <button class="btn btn-primary" type="button">49,99 €</button> <button href="#" class="btn btn-default" type="button"><span class="glyphicon glyphicon-heart"></span> Add to Wishlist</button>       
                                                </div><!-- End Item -->
                                                <div class="item">
                                                    <a href="#"><img src="Watch2" class="img-responsive" alt="product 2"></a>
                                                    <h4><small>watches-for-men-fossil</small></h4>                                        
                                                    <button class="btn btn-primary" type="button">9,99 €</button> <button href="#" class="btn btn-default" type="button"><span class="glyphicon glyphicon-heart"></span> Add to Wishlist</button>        
                                                </div><!-- End Item -->
                                                <div class="item">
                                                    <a href="#"><img src="Watch3" class="img-responsive" alt="product 3"></a>
                                                    <h4><small> Dial Gunmetal Sandstone</small></h4>                                        
                                                    <button class="btn btn-primary" type="button">₹9,093 </button> <button href="#" class="btn btn-default" type="button"><span class="glyphicon glyphicon-heart"></span> Add to Wishlist</button>      
                                                </div><!-- End Item -->                                
                					...
                					<li class="col-sm-3">
                						<ul>
                                            ...
                                            <li><a href="#">Field Watches</a></li>
                							<li><a href="#">Aviator Watches</a></li>
                							<li class="divider"></li>
                                    ...
                                    <li class="col-sm-3">
                    					<ul>
                                            ...
                                            <div id="womenCollection" class="carousel slide" data-ride="carousel">
                                              <div class="carousel-inner">
                                                <div class="item active">
                                                    <a href="#"><img src="w1" class="img-responsive" alt="product 1"></a>
                                                    <h4><small>High Quality Leather Strap Watches Women</small></h4>                                        
                                                    <button class="btn btn-primary" type="button">5.99€</button> <button href="#" class="btn btn-default" type="button"><span class="glyphicon glyphicon-heart"></span> Add to Wishlist</button>       
                                                </div><!-- End Item -->
                                                <div class="item">
                                                    <a href="#"><img src="w2" class="img-responsive" alt="product 2"></a>
                                                    <h4><small>Rodeo</small></h4>                                        
                                                    <button class="btn btn-primary" type="button">9,99 €</button> <button href="#" class="btn btn-default" type="button"><span class="glyphicon glyphicon-heart"></span> Add to Wishlist</button>        
                                                </div><!-- End Item -->
                                                <div class="item">
                                                    <a href="#"><img src="" class="img-responsive" alt="product 3"></a>
                                                    <h4><small>Enakei fashion silica gel diamond jelly</small></h4>                                        
                                                    <button class="btn btn-primary" type="button">49,99 €</button> <button href="#" class="btn btn-default" type="button"><span class="glyphicon glyphicon-heart"></span> Add to Wishlist</button>      
                                                </div><!-- End Item -->                                
                                              </div><!-- End Carousel Inner -->
                                              <!-- Controls -->
		...
		<nav id="sidebar-wrapper">
			<ul class="sidebar-nav">
				...
				<li class="sidebar-brand">
					<a href="#top">Welcome  <strong>TimeToTime</strong></a>
				</li>
				<li>
