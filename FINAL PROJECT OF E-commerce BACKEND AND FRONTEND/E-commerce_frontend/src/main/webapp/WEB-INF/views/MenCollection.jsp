...
<center>
<h2><strong> <p class="text-danger">MEN'S WATCHES</p>  </strong></h2>
</center>
...
<td><c:if test="${prod.category.categoryName =='MENCOLLECTION'}">  <a href="showproduct/${prod.id}">
<div class="col-md-4">
<img src = "<c:url value ='/resource/images/${prod.id}.jpg'/>" height="200" width="200"/></a><br>
 ${prod.name}<br/>
<i> RS ${prod.price}
<br/>
<!-- <a href ="showproduct" input type="submit" class="btn btn-primary" value="Add To Cart">Add To Cart</a> -->
