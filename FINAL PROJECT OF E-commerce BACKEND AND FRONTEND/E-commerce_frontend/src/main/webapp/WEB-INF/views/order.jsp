...
<body>
       ...
       <td><b>${sum}</td>
             ...
             <a href = "thankyou" input class="btn btn-info" name="_eventId_submit" type="submit"value="Next" /> Next</a>
             <!-- <input class="btn btn-info" name="_eventId_submit" type="submit"value="Next" /> -->
        </div>
         </div>
        
       <div class="container">
       <a href="home"input class="btn btn-success" name="_eventId_submit" type="submit"value="BACK TO HOME" >BACK TO HOME</a>
