...
<thead>
    ...
    <!-- <tr> -->
     <tr class="info">
       ...
       <th width="140">Price</th>
        ...
        <th width="160">Action <span class="glyphicon glyphicon-edit"></span></th>
        <th width="200">Action <span class="glyphicon glyphicon-trash"></span></th>
    ...
    <c:forEach items="${products}" var="product">
        <tr>
            ...
            <td>${product.name}</td>
            <td>${product.price}</td>
            <td><img src="<c:url value='/resource/images/${product.id }.jpg' />" class ="image-responsive" height="50" width="50" /></td>
