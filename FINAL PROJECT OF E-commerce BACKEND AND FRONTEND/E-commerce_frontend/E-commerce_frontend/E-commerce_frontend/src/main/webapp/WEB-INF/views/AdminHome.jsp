...
<ul class="nav navbar-nav navbar-right">
    ...
    <li class="active"><a id="log" href="#"> Welcome :<img src = "<c:url value ='/resources/images/users/${pageContext.request.userPrincipal.name}.png'/>"height="20" width="20" class ="img img-rounded"/>${pageContext.request.userPrincipal.name}</a></li>
