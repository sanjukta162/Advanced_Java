...
<!-- <link href="/WEB-INF/resource/css/css.css" rel="stylesheet" type="text/css"> -->
...
<div class="container">
  ...
  <img src="resource/images/img1.jpg" class="img-rounded" alt="Product1"  width="100%" height="auto">
      ...
      <div class="item">
        <img src="resource/images/img2.jpg" class="img-rounded" alt="Product2" max-width="100%" height="100%">
      </div>
