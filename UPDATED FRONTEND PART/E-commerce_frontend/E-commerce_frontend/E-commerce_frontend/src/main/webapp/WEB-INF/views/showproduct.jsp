...
<div class="container" id="product-section">
  ...
  <div class="row">
   <div class="col-md-5">
 <img  height="500px" width="400px" alt="${product.id}" src="<c:url value="/resource/images/${product.id}.jpg">
 </c:url>">
...
<a href="${session.getContextPath()}/E-commerce_frontend/order/${product.id}" class="btn btn-warning btn-lg">
