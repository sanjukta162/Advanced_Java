  ...
  <!--   <strong><a class="navbar-brand" href="home"> Time To Shine</a></strong>-->
     ...
     <div id="navbar" class="collapse navbar-collapse">
      ...
      <li class="active"><a href="${url1}">Home <span  class= "glyphicon glyphicon-home"></span></a></li> --%>
       ...
       <li class="active"><a href="${session.getContextPath()}/E-commerce_frontend/index">Home <span  class= "glyphicon glyphicon-home"></span></a></li>
      ...
      <security:authorize  access ="hasRole('ROLE_ADMIN')">
        <a href="${url5}">Admin <span class = "glyphicon glyphicon-shopping-cart"></span></a>
        </security:authorize>
        </c:if>
...
<div class="container">
  ...
  <h3>
 <i><strong>WELCOME TO WATCH WORLD !!!!</strong></i>
 </h3>
</div>
</body>
</html>              