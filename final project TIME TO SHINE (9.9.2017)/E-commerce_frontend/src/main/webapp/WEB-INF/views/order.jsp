...
<body>
    ...
    <a href = "thankyou" input class="btn btn-info  btn-lg" name="_eventId_submit" type="submit"value="Next" />
              Next</a>
       ...
       <div class="container">
       <a href="home"input class="btn btn-success btn-lg" name="_eventId_submit" type="submit"value="CONTINUE SHOPPING" >
       <span class="glyphicon glyphicon-chevron-left">CONTINUE SHOPPING</span></a>
